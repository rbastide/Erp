...
const handleValidate = () => { console.log("Validée !") } //TODO mettre en place le vrai fonctionnement
...
<template>
  <Sidebar />
  <AppHeader title="Validation Ressource" :inline="`${resourceCode} du ${resourceDate}`" />
  ...
  <main class="main-content">
    <div class="container">
      ...
      <div class="actions-footer">
        ...
        <button v-if="!isAccepted" @click="handleAccept" class="btn btn-primary">Accepter les informations</button>
        <button v-if="isAccepted" @click="handleValidate" class="btn btn-primary">Valider et envoyer la fiche</button>
