  ...
  <div class="main-content">
    ...
    <div class="settings-group">
      ...
      <div class="setting-card">
        <div class="card-header">
          <div class="icon-circle">
            <svg width="28" height="28" viewBox="0 0 24 24"  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
          </div>
          <h3>Notifications</h3>
        </div>
        ...
        <div class="setting-row">
          <div class="text-info">
            <span class="label">Alertes email (ne fonctionne pas pour la version actuelle)</span>
            <span class="desc">Recevoir un rappel par mail</span>
          </div>
