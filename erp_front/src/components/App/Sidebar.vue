...
<template>
  ...
  >
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-item" :class="{ active: props.dashboard }" @click="handleDashboard">
      ...
      <div class="nav-item" :class="{ active: props.dashboardAdmin }" @click="handleAdmin">
        <div class="icon-wrapper">
      ...
      <div class="nav-item" :class="{ active: props.settings }" @click="handleSettings">
        <div class="icon-wrapper">
    ...
    <div class="sidebar-footer">
      <div class="nav-item small" @click="handleAide">
        <div class="icon-wrapper">
      ...
      <div class="nav-item small logout" @click="handleDeconnexion">
        <div class="icon-wrapper">
