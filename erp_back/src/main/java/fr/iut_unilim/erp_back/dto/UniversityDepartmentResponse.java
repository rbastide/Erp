...
public class UniversityDepartmentResponse {
    ...
    public UniversityDepartmentResponse(Long univeristyDepartmentID, String universityName, String universityDepartmentName, String city, Date date) {
        this.univeristyDepartmentID = univeristyDepartmentID;
